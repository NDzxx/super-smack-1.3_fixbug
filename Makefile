...
LEX = flex
LN_S = ln -s
MAKEINFO = /www/myh5_press/mysqltool/super-smack-1.3/missing makeinfo
MYSQL_INCLUDE = -I/www/server/mysql/include
MYSQL_LIB = -L/www/server/mysql/lib/ -lmysqlclient 
ORACLE_INCLUDE = 
ORACLE_LIB = 
PACKAGE = super-smack
PGSQL_INCLUDE = 
...
DATADIR = /usr/local/super-smack/smack-data/
